...
# Linear regression between log10(BA) and −log10(1/(BRbias/CR)−1) (Fig. S6a)
# fit: −log10(1/(BRbias/CR)−1)=-1.083(±0.311)log10BA+5.554(±1.818), R2=0.202, P=0.001
...
# Transformed empirical equation based on the regression in Fig. S6a (Fig. S6b)
# fit: BRbias/CR=1/(1+10^(1.083(±0.311)log10BA-5.554(±1.818)))
...
theme(panel.grid = element_blank(), 
	...
	legend.key = element_blank()) +
geom_point(color = '#eeb421', size = 3) +
stat_function(fun = function(x) 1/(10^(1.083*log10(x)-5.554)+1), color = 'black', size = 1) +
