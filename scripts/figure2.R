...
env <- dat[c('Temperature', 'Salinity', 'NO3', 'PO4', 'Si', 'DO', 'Chla', 'BA_t0', 'BP_t0', 'sBP_t0', 'BA_fold', 'BP_fold', 'sBP_fold', 'BRbias_CR')]
names(env) <- c('Temperature', 'Salinity', 'NO3', 'PO4', 'Si', 'DO', 'Chla', 'BAt0', 'BPt0', 'sBPt0', 'BAt1/BAt0', 'BPt1/BPt0', 'sBPt1/sBPt0', 'BRbias/CR')
