...
# Satellite-derived estimates of NCP from O2/Ar observations, calculated as Li and Cassar (2016) (Fig. S8a)
...
# Global carbon export estimates obtained from an inverse biogeochemical model, calculated as Wang et al (2023) (Fig. S8b)
...
# Global carbon export estimates based on the 234Th-derived empirical carbon export ratio (f-ratio), calculated as Henson et al (2011) (Fig. S8c)
